...
contract PreIcoCrowdsale is FinalizableCrowdsale,RefundableCrowdsale,Destructible {
    ...
    function PreIcoCrowdsale(uint256 _rate, uint256 _goal, address _wallet, uint256 _releaseTime, uint256 _minTransactionValue) public
       
        FinalizableCrowdsale()
        RefundableCrowdsale(_goal)
        Crowdsale(_rate,_wallet,_releaseTime,_minTransactionValue) 
        {
